    ...
    >
      <View style={styles.formCard}>
        ...
        <TextInput
          ...
          onChangeText={(v) => handleChange("categoryId", v)}
          style={styles.input}
        />
        <TextInput
          label="Price"
      ...
      <View style={styles.tabs}>
        ...
        <Button
          mode={selectedTab === "products" ? "contained" : "outlined"}
        ...
        <Button
          mode={selectedTab === "categories" ? "contained" : "outlined"}
      ...
      {selectedTab === "users" && (
        <View style={styles.emptySection}>
          <Text>Users management UI (TODO)</Text>
        </View>
      )}

      {selectedTab === "categories" && (
        <View style={styles.emptySection}>
          <Text>Categories management UI (TODO)</Text>
        </View>
      )}
    </ScrollView>
  );
